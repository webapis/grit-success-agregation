...
async function runAggregation() {
    ...
    try {
        ...
        const pipeline = [
            ...
            setH1ByField({ id: 6, field: 'title' }),
            setH1ByField({ id: 5, field: 'title' }),
            ...
            setH3ByField({ id: 6, field: 'title' }),
            setH3ByField({ id: 5, field: 'title' }),
            ...
            // setH1ByField({ id: 3, field: 'pageTitle' }),
            // setH1ByField({ id: 4, field: 'pageTitle' }),

            // setH3ByField({ id: 1, field: 'pageTitle' }),
            // setH3ByField({ id: 2, field: 'pageTitle' }),
            // setH3ByField({ id: 3, field: 'pageTitle' }),
            // setH3ByField({ id: 4, field: 'pageTitle' }),

            // setH4ByField({ id: 1, field: 'pageTitle' }),
            // setH4ByField({ id: 2, field: 'pageTitle' }),
            // setH4ByField({ id: 3, field: 'pageTitle' }),
            // setH4ByField({ id: 4, field: 'pageTitle' }),

            // setH1ByField({ id: 1, field: 'imgString' }),
            // setH1ByField({ id: 2, field: 'imgString' }),
            // setH1ByField({ id: 3, field: 'imgString' }),
            // setH1ByField({ id: 4, field: 'imgString' }),

            // setH3ByField({ id: 1, field: 'imgString' }),
            // setH3ByField({ id: 2, field: 'imgString' }),
            // setH3ByField({ id: 3, field: 'imgString' }),
            // setH3ByField({ id: 4, field: 'imgString' }),

            // setH4ByField({ id: 1, field: 'imgString' }),
            // setH4ByField({ id: 2, field: 'imgString' }),
            // setH4ByField({ id: 3, field: 'imgString' }),
            // setH4ByField({ id: 4, field: 'imgString' }),
