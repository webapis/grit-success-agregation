/*
i need to move image validation to before .slice(0, 2) after sorting. first i need to validated image after perform slicing in order to get object with
valid image. validation should be performed upto 5 images in  group.children. if first two objects got valid image url then validation can be ended. because
we got valid images we needed. if object with valid image url not found then search for valid image url should be performed up until 15 objects withing group.children
should be searched if image not found error should be logged
*/
import fs from 'fs';
